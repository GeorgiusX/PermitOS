...
// Default callout positions for issues that lack normalized coordinates.
...
export function PlanViewer({
  ...
  // Only place callouts for actionable issues (not passes).
      ...
      <div className="flex flex-1 items-center justify-center overflow-auto p-5">
        <div className="shrink-0 rounded-lg border border-border-strong bg-surface">
          ...
          >
            ...
            {/* room labels */}
            <text x="175" y="97" textAnchor="middle" fontSize="9" fill="#777">
              LIVING / DINING
            </text>
            <text x="91" y="178" textAnchor="middle" fontSize="8" fill="#777">
              KITCHEN
            </text>
            <text x="182" y="173" textAnchor="middle" fontSize="8" fill="#777">
              BED 1
            </text>
            <text x="264" y="173" textAnchor="middle" fontSize="8" fill="#777">
              BED 2
            </text>
            <text x="91" y="232" textAnchor="middle" fontSize="8" fill="#777">
              BATH
            </text>
            <text x="182" y="232" textAnchor="middle" fontSize="8" fill="#777">
              BED 3
            </text>
            <text x="264" y="232" textAnchor="middle" fontSize="8" fill="#777">
              UTILITY
            </text>
            {/* trees */}
            ...
            <rect
              ...
              rx="2"
            />
            <text x="52" y="326" fontSize="8" fill="#888">
              PROJECT
            </text>
            <text x="95" y="326" fontSize="8" fill="#444" fontWeight="500">
              {projectTitle.slice(0, 48)}
            </text>
            <text x="52" y="340" fontSize="8" fill="#888">
              PERMIT
            </text>
            <text x="95" y="340" fontSize="8" fill="#444">
              {permitNo ?? "—"}
            </text>
            <text x="52" y="354" fontSize="8" fill="#888">
              SHEET
            </text>
            <text x="95" y="354" fontSize="8" fill="#444">
              {sheetLabel}
            </text>
          </svg>
        </div>
